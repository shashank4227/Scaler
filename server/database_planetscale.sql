...
-- Note: Foreign keys are removed for free tier compatibility
-- You can enforce relationships in application code or upgrade to paid plan
...
CREATE TABLE IF NOT EXISTS categories (
    ...
    -- FOREIGN KEY removed for PlanetScale free tier compatibility
);
