            ...
            <div className="max-w-screen-2xl mx-auto px-4">
                <div className="flex items-center justify-between h-[68px] gap-6">
                    ...
                    <div className="flex items-center gap-6 text-gray-700 font-medium flex-shrink-0">
                        ...
                        >
                            <button
                                className="flex items-center gap-2 text-sm hover:text-primary px-3 py-2 rounded-sm hover:bg-blue-50 transition"
                                onClick={() => {
                                    if (!isAuthenticated) {
                                        navigate('/login');
                                    }
                            ...
                            >
                                ...
                                {isAuthenticated ? (user?.name || user?.email) : 'Login'}
                                {isAuthenticated && (
                            ...
                            {showLoginDropdown && isAuthenticated && (
                                <div className="absolute top-full right-0 w-60 z-50 pt-2">
                                    <div className="bg-white text-gray-700 shadow-xl rounded-sm border">
                        ...
                        {/* Cart */}
                        <Link to="/cart" className="flex items-center gap-2 text-sm cursor-pointer hover:text-primary px-2 py-2 rounded-sm hover:bg-blue-50 transition">
                            <div className="relative">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* Become a Seller */}
                        <span className="text-sm cursor-pointer hover:text-primary flex items-center gap-2 px-2 py-2 rounded-sm hover:bg-blue-50 transition">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* More Menu */}
                        <button className="text-gray-500 hover:text-primary px-2 py-2 rounded-sm hover:bg-blue-50 transition" aria-label="More">
